...
if( $this->uri->segment(1)=='manage_student_admission_csv' ){
...
<div id="printArea">
    ...
    <table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr style="height:100px;">
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->NAME; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->AGE; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->PUBLIC_ID; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->PHONE; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->CLASS_NAME; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->SECTION_NAME; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->ROLL_NO; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $stu_data->YEAR; ?></td>
          <td align="center" style="vertical-align:middle">
                <img src="<?php echo $this->webspice->settings()->site_url.'global/custom_files/student/'.$stu_data->STUDENT_ID.'.jpg'; ?>"  alt="Student Photograph" class="img-responsive" width="100" />
          </td>
