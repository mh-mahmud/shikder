//<!--
var url_prefix = '/shikder/'; /*should be start and end with / (slash)*/
...
init = function(){
	...
	switch(page){
		...
		case 'page_sms_marksheet': page_sms_marksheet(); break;
...
page_sms_marksheet = function() {
	$("#exam_id").on( 'change', function() {
		...
		$.ajax({
			type: "POST",
			url: url_prefix + 'exam_wise_student_list',
			data: {
				exam_id: exam_id,
				class_id: class_id,
				csrf_webspice_tkn: token
